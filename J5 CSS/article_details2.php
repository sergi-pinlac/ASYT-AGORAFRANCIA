...
body {
  ...
  background-image: url('images/grece.jpg'); /* 🔄 mets ici l’image que tu veux */
...
.article-details img {
  max-width: 40%;   /* L’image ne dépassera jamais 70% de la largeur du conteneur */
  height: auto;
  opacity: 1;
  display: block;
...
/* Optionnel : évite l’opacité sur le conteneur article */
.article-details {
  opacity: 1 !important;
}
