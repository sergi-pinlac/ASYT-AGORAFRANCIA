...
// Filtre par catégorie (attention à la casse et aux espaces)
...
// Exclure les articles déjà vendus (assure que vendu est bien égal à 0)
...
try {
    ...
    // Débogage (facultatif)
    // echo "<pre>"; var_dump($sql, $params); echo "</pre>";
} catch (Exception $e) {
